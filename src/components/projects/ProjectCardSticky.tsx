    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/[0.08] pb-6 mb-8">
        <div className="flex items-center gap-4">
          ...
          <span className="font-mono text-xs md:text-sm uppercase tracking-widest text-foreground-secondary">
            {project.category}
          </span>
        </div>
        <div className="flex items-center gap-4">
          <span className="font-mono text-xs uppercase tracking-wider text-foreground-secondary/60">
            {project.role}
          </span>
          {project.liveUrl && (
            <a
              ...
              className="px-3.5 py-1.5 rounded-full bg-dx-purple/20 hover:bg-dx-purple border border-dx-purple-bright/40 text-xs font-mono text-white font-bold transition-all duration-300 flex items-center gap-1.5"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        <div className="lg:col-span-6 space-y-5">
          <h3 className="font-display text-4xl sm:text-5xl lg:text-5xl font-black uppercase tracking-tight text-white group-hover:text-dx-purple-bright transition-colors duration-500 leading-tight">
            {project.title}
          </h3>
