    ...
    >
      ...
      <div className="divide-y divide-white/[0.08] border-y border-white/[0.08]">
        {studioConfig.processSteps.map((step) => (
          <div
            key={step.number}
            className="group py-12 md:py-16 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start hover:bg-white/[0.015] transition-colors duration-500 px-4 md:px-6 rounded-2xl"
          >
            {/* Number */}
            <div className="lg:col-span-2">
              <span className="font-mono text-3xl md:text-5xl font-black text-white/30 group-hover:text-dx-purple-bright transition-colors duration-500">
                {step.number}
              </span>
            </div>
            ...
            <div className="lg:col-span-4 space-y-2">
              <h3 className="font-display text-3xl md:text-5xl font-black uppercase tracking-tight text-white group-hover:translate-x-2 transition-transform duration-500">
                {step.phase}
              </h3>
              <p className="font-handwritten text-dx-purple-bright text-lg md:text-xl font-bold">
                {step.tagline}
              </p>
            </div>
            ...
            <div className="lg:col-span-6 space-y-6">
              <p className="font-sans text-base md:text-lg text-foreground-secondary leading-relaxed">
                {step.description}
              </p>
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                {step.deliverables.map((item) => (
                  <span
                    key={item}
                    className="px-3 py-1 rounded-full bg-white/[0.04] border border-white/[0.08] font-mono text-[10px] uppercase tracking-wider text-foreground-secondary/80"
                  >
                    {item}
                  </span>
                ))}
